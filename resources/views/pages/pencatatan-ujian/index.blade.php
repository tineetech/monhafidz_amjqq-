...
<section class="content">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">Data Ujian Santri Ziyadah</h3>
      <div class="box-tools">
    ...
    <div class="box-body table-responsive">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach ($ujianZiyadah as $index => $u)
            <tr>
                <td>{{ $index + 1 }}</td>
  ...
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">Data Ujian Santri Murajaah</h3>
      <div class="box-tools">
        <div class="" style="display: flex; gap: 8px;width: auto;">
          <form action="" method="GET" style="display: flex;gap:3px">
            <select name="filter_semester" class="form-control" style="margin-right: 5px;" id="">
    ...
    <div class="box-body table-responsive">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach ($ujianMurajaah as $index => $u)
            <tr>
                <td>{{ $index + 1 }}</td>
