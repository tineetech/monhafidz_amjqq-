...
<section class="content-header">
  <h1>Edit Jadwal Ujian Tasmi</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="{{ route('jadwal-ujian.index') }}">Jadwal Ujian Tasmi</a></li>
...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Edit Jadwal Ujian Tasmi</h3>
      <div class="box-tools">
        <a href="{{ route('jadwal-ujian-tasmi.index') }}" class="btn btn-primary btn-sm">
    ...
    <div class="box-body">
      <form action="{{ route('jadwal-ujian-tasmi.update', $jadwal->id) }}" method="POST">
        @csrf
        @method('PUT')
