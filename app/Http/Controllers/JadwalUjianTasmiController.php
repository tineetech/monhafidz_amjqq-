...
class JadwalUjianTasmiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $jadwalQuery = JadwalUjianTasmi::with(['santri', 'semester', 'pembimbingPutra', 'pembimbingPutri'])
        ...
        return view('pages.jadwal-ujian-tasmi.index', compact('jadwal', 'semesters'));
    }
    /**
    ...
    public function create()
    {
        ...
        return view('pages.jadwal-ujian-tasmi.create', compact('santris','ustadzah','semesters'));
    }
